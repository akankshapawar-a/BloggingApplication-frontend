...
//         className="absolute top-0 left-0 p-2 bg-gray-200 rounded-r-md focus:outline-none z-10"
//       >
//         {open ? <IoIosArrowBack className="h-6 w-6" /> : <IoIosArrowForward className="h-6 w-6" />}
//       </button>

    
//       <div className={`fixed inset-y-0 left-0 z-20 bg-white w-72 transition-transform duration-300 overflow-y-auto border-r border-gray-200 ${open ? '' : '-translate-x-full'}`}>
...
//         </div>
//         <div className="mt-2 ">
//           <NavLink to="/admin/home" className="block px-4 ml-4 rounded-md mr-4 py-3  text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">
//             <IoIosHome className="h-7 w-7 mr-2 ml-12 " />
//             <p className='ml-10 text-base'>Home</p>
//           </NavLink>
//           <NavLink to="/admin/about" className="block  px-4 ml-4 rounded-md mr-4  py-3 text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">
//             <IoMdPeople className="h-7 w-7 mr-2 ml-12" />
//           <p className='ml-10 text-base'> Users</p> 
//           </NavLink>
//           <NavLink to="/admin/analytics" className="block  px-4  ml-4 rounded-md mr-4   py-3 text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900">
